...
PRECTFILE="/glade/p/cesmLE/CESM-CAM5-BGC-LE/atm/proc/tseries/hourly6/PRECT/b.e11."${RUNCONFIG}".f09_g16."${NUMID}".cam.h2.PRECT."${RUNDATES}".nc"
PRECVARNAME="PRECT"
PSLFILE="/glade/p/cesmLE/CESM-CAM5-BGC-LE/atm/proc/tseries/hourly6/PSL/b.e11."${RUNCONFIG}".f09_g16."${NUMID}".cam.h2.PSL."${RUNDATES}".nc"
PSLVARNAME="PSL"
...
if [ ${DO_TEMPEST} == 'true' ]; then
  ...
  BUILDDIR=/glade/p/work/zarzycki/tempestextremes_noMPI/bin/
  ...
  ls "/glade/p/cesmLE/CESM-CAM5-BGC-LE/atm/proc/tseries/hourly6/PSL/b.e11."${RUNCONFIG}".f09_g16."${NUMID}".cam.h2.PSL."${RUNDATES}".nc" -1 > ${FILELISTNAME}
