...
C                                             ! input
      ...
      real d(ilon,jlat,klev)
      real u(ilon,jlat,klev)
      real v(ilon,jlat,klev)
      real pmid(ilon,jlat,klev)
      real pdel(ilon,jlat,klev)
